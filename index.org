...
*** Using branches
By default git uses a =master= branch.  To switch to a different branch =M-x magit-status= and =b=, and =b= for /checkout/.
...
# PUT THIS IN .HTML TO left-align and DIMINISH fonts
# <section id="sec-5" style="text-align: left; font-size: 0.53em;">
